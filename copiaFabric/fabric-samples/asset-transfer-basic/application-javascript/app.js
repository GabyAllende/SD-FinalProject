...
const client = mqtt.connect('mqtt://research.upb.edu:21212')
...
async function main() {
    try {
		...
		if (topic === "upb/blockchain/verify") 
		{
            ...
            /*
            //console.log('\n--> Submit Transaction: CreateAsset, creates new asset with ID, owner');
            //result = await contract.submitTransaction('CreateAsset', 'asset44','Sarmiento');
            ...
            result = await contract.evaluateTransaction('ReadAsset', 'asset44');
            console.log(`*** Result: ${prettyJSONString(result.toString())}`);
            ...
            await contract.submitTransaction('UpdateAsset', 'asset1','Arnez');
            console.log('*** Result: committed');
            ...
            try {
            	...
            	await contract.submitTransaction('UpdateAsset', 'asset70' , 'Duran');
            ...
            await contract.submitTransaction('TransferAsset', 'asset1', 'Duran');
            console.log('*** Result: committed');
